...
const bookTitle = prompt("Enter the title of the book you are looking for:");
const book = programmingBooks.find(title => title.toLowerCase() === bookTitle.toLowerCase());

if (book) {
  alert(`The book "${bookTitle}" is in the library at index ${programmingBooks.indexOf(book)}.`);
} else {
  alert(`The book "${bookTitle}" is not found in the library.`);
}
